...
export const LINES = {
  ...
  [LINE_IDS.jr_east.shinkansen.tohoku]: new Line('東北新幹線', 'JR東日本', [], [
    new StopStationDef(STATION_IDS.jr_east.tokyo),
    new StopStationDef(STATION_IDS.jr_east.ueno),
    new StopStationDef(STATION_IDS.jr_east.omiya),
    new StopStationDef(STATION_IDS.jr_east.oyama),
    ...
    new StopStationDef(STATION_IDS.jr_east.furukawa),
    new StopStationDef(STATION_IDS.jr_east.kurikoma_kogen),
    new StopStationDef(STATION_IDS.jr_east.ichinoseki),
    new StopStationDef(STATION_IDS.jr_east.mizusawaesashi),
    new StopStationDef(STATION_IDS.jr_east.kitakami),
    new StopStationDef(STATION_IDS.jr_east.shin_hanamaki),
    new StopStationDef(STATION_IDS.jr_east.morioka),
    new StopStationDef(STATION_IDS.jr_east.iwate_numakunai),
    new StopStationDef(STATION_IDS.jr_east.ninohe),
    new StopStationDef(STATION_IDS.jr_east.hachinohe),
    new StopStationDef(STATION_IDS.jr_east.shichinohe_towada),
