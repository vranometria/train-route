...
export const LINES = {
  // #region 京浜急行電鉄
  [LINE_IDS.keikyu.honsen]: new Line('京急本線', COMPANIES.keikyu.id, [
  ...
  [LINE_IDS.keikyu.kurihama]: new Line('久里浜線', COMPANIES.keikyu.id, [
    new KindDef("快特", "rapid"),
    new KindDef("特急", "special-express"),
  ], [
  ...
  [LINE_IDS.keikyu.zushi]: new Line('逗子線', COMPANIES.keikyu.id, [
    new KindDef("急行", "express"),
    new KindDef("特急", "special-express"),
  ], [
  ...
  [LINE_IDS.keikyu.daishi]: new Line('大師線', COMPANIES.keikyu.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.keikyu.haneda_kuko]: new Line('羽田空港線', COMPANIES.keikyu.id, [
    new KindDef("快特", "rapid"),
    new KindDef("急行", "express"),
    new KindDef("特急", "special-express"),
  ...
  [LINE_IDS.keikyu.sea_side]: new Line('シーサイドライン', COMPANIES.keikyu.id, LOCAL_ONLY, [
  ...
  // #endregion
  // #region 都営地下鉄(東京都交通局)
  [LINE_IDS.tokyo_subway.asakusa]: new Line('浅草線', COMPANIES.tokyo_koutsukyoku.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_subway.shinjuku]: new Line('新宿線', COMPANIES.tokyo_koutsukyoku.id, [new KindDef("急行", "express")], [
  ...
  [LINE_IDS.tokyo_subway.oedo]: new Line('大江戸線', COMPANIES.tokyo_koutsukyoku.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_subway.mita]: new Line('三田線', COMPANIES.tokyo_koutsukyoku.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_subway.nippori_toneri_liner]: new Line('日暮里・舎人ライナー', COMPANIES.tokyo_koutsukyoku.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_subway.sakura_tram]: new Line('東京さくらトラム', COMPANIES.tokyo_koutsukyoku.id, LOCAL_ONLY, [
  ...
  // #endregion
  // #region 東京メトロ
  [LINE_IDS.tokyo_metro.hibiya]: new Line('日比谷線', COMPANIES.tokyo_metro.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_metro.marunouchi]: new Line('丸ノ内線', COMPANIES.tokyo_metro.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_metro.chiyoda]: new Line('千代田線', COMPANIES.tokyo_metro.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_metro.touzai]: new Line('東西線', COMPANIES.tokyo_metro.id, [new KindDef("通勤快速", "commuter"), new Rapid], [
  ...
  [LINE_IDS.tokyo_metro.yurakucho]: new Line('有楽町線', COMPANIES.tokyo_metro.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_metro.fukutoshin]: new Line('副都心線', COMPANIES.tokyo_metro.id, [new KindDef("通勤急行", "commuter"), new KindDef("急行", "express")], [
  ...
  [LINE_IDS.tokyo_metro.ginza]: new Line('銀座線', COMPANIES.tokyo_metro.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.tokyo_metro.hanzoumon]: new Line('半蔵門線', COMPANIES.tokyo_metro.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.shibuya),
    new StopStationDef(STATION_IDS.tokyo_metro.omotesando),
    new StopStationDef(STATION_IDS.tokyo_subway.aoyama_itchome),
    new StopStationDef(STATION_IDS.tokyo_metro.nagatacho),
  ...
  [LINE_IDS.tokyo_metro.nanboku]: new Line('南北線', COMPANIES.tokyo_metro.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.meguro),
    new StopStationDef(STATION_IDS.tokyo_metro.shirokanedai),
    new StopStationDef(STATION_IDS.tokyo_metro.shirokane_takanawa),
    new StopStationDef(STATION_IDS.tokyo_subway.azabujuban),
  ...
  // #endregion
  // #region 東京モノレール
  [LINE_IDS.tokyo_monorail.haneda_kuko]: new Line('羽田空港線', COMPANIES.tokyo_monorail.id, [], [
  ...
  // #endregion
  // #region 東京高速鉄道
  [LINE_IDS.toukyo_rinkai_kousoku.rinkai]: new Line('りんかい線', COMPANIES.toukyo_rinkai_kousoku.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.tokyo_metro.shinkiba),
  ...
  // #endregion
  // #region ゆりかもめ
  [LINE_IDS.yurikamome.yurikamome]: new Line('ゆりかもめ', COMPANIES.yurikamome.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.shinbashi),
    new StopStationDef(STATION_IDS.tokyo_subway.shiodome),
  ...
  // #endregion
  // #region 千葉都市モノレール
  [LINE_IDS.chiba_toshi_monorail.ichigou]: new Line('1号線', COMPANIES.chiba_urban_monorail.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.chiba_toshi_monorail.nigou]: new Line('2号線', COMPANIES.chiba_urban_monorail.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.chiba),
  ...
  // #endregion
  // #region 横浜市営地下鉄
  [LINE_IDS.yokohama_subway.blue_line]: new Line('ブルーライン', COMPANIES.yokohama_subway.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.yokohama_subway.green_line]: new Line('グリーンライン', COMPANIES.yokohama_subway.id, LOCAL_ONLY, [
  ...
  // #endregion
  // #region 横浜高速鉄道
  [LINE_IDS.yokohama_kousoku.minato_mirai]: new Line('みなとみらい線', COMPANIES.yokohama_kousoku.id, LOCAL_ONLY, [
  ...
  // #endregion
  // #region 東急
  [LINE_IDS.toukyu.touyoko]: new Line('東横線', COMPANIES.tokyu.id, [new Express], [
  ...
  [LINE_IDS.toukyu.ikegami]: new Line('池上線', COMPANIES.tokyu.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.gotanda),
  ...
  [LINE_IDS.toukyu.tamagawa]: new Line('多摩川線', COMPANIES.tokyu.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.toukyu.tamagawa),
  ...
  [LINE_IDS.toukyu.denentoshi]: new Line('田園都市線', COMPANIES.tokyu.id, [new Rapid, new SemiExpress],
    [
      ...
      new StopStationDef(STATION_IDS.toukyu.sangenjaya, ["express","semi-express"]),
      ...
      new StopStationDef(STATION_IDS.toukyu.futakotamagawa, ["express","semi-express"]),
      ...
      new StopStationDef(STATION_IDS.toukyu.washinuma, ["express","semi-express"]),
      new StopStationDef(STATION_IDS.toukyu.tama_plaza, ["express","semi-express"]),
      new StopStationDef(STATION_IDS.toukyu.azamino, ["express","semi-express"]),
      ...
      new StopStationDef(STATION_IDS.toukyu.aobadai, ["express","semi-express"]),
      ...
      new StopStationDef(STATION_IDS.toukyu.minamimachida_grandberry_park, ["express","semi-express"]),
  ...
  [LINE_IDS.toukyu.oimachi]: new Line('大井町線', COMPANIES.tokyu.id, [new KindDef("急行・準急", "express")], [
  ...
  [LINE_IDS.toukyu.meguro]: new Line('目黒線', COMPANIES.tokyu.id, [new KindDef("急行・準急", "express")], [
  ...
  [LINE_IDS.toukyu.shin_yokohama]: new Line('新横浜線', COMPANIES.tokyu.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.shin_yokohama),
    new StopStationDef(STATION_IDS.toukyu.shin_tsunashima),
    new StopStationDef(STATION_IDS.yokohama_subway.hiyoshi),
  ]),
  [LINE_IDS.toukyu.setagaya]: new Line('世田谷線', COMPANIES.tokyu.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.toukyu.kodomonokuni]: new Line('こどもの国線', COMPANIES.tokyu.id, LOCAL_ONLY, [
  ...
  // #endregion
  // #region 相模鉄道
  [LINE_IDS.sagami.honsen]: new Line('相鉄本線', COMPANIES.sotetsu.id,[
  ...
  [LINE_IDS.sagami.sotetsushin_yokohama]: new Line('相鉄新横浜線', COMPANIES.sotetsu.id, [], [
    new StopStationDef(STATION_IDS.jr_east.shin_yokohama),
    new StopStationDef(STATION_IDS.sagami.hazawayokohamakokudai),
    new StopStationDef(STATION_IDS.yokohama_subway.hiyoshi),
  ]),
  [LINE_IDS.sagami.izumino]: new Line('いずみ野線', COMPANIES.sotetsu.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.sagami.futamatagawa),
  ...
  // #endregion
  // #region 小田急
  [LINE_IDS.odakyu.enoshima]: new Line('江ノ島線', COMPANIES.odakyu.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.odakyu.sagamiono, [
  ...
  [LINE_IDS.odakyu.odawara]: new Line('小田原線', COMPANIES.odakyu.id, [
  ...
  [LINE_IDS.odakyu.hakonetozan]: new Line('箱根登山鉄道線', COMPANIES.odakyu.id, LOCAL_ONLY, [
  ...
  // #endregion
  // #region 首都圏新都市
  [LINE_IDS.shutoken_shintoshi.tsukuba_express]: new Line('つくばエクスプレス', COMPANIES.shutoken_shintoshi.id, [
  ...
  // #endregion
  // #region 小田急箱根
  [LINE_IDS.odakyu_hakone.kousaku]: new Line('鋼索線(箱根登山ケーブルカー)', COMPANIES.odakyu_hakone.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.odakyu.goura),
  ...
  [LINE_IDS.jr_east.chuou_honsen]: new Line('中央本線', 'JR東日本', [new KindDef("快速", "rapid")], [
    new StopStationDef(STATION_IDS.jr_east.tokyo, ["rapid"]),
    new StopStationDef(STATION_IDS.jr_east.kanda),
    new StopStationDef(STATION_IDS.jr_east.ochanomizu),
    new StopStationDef(STATION_IDS.jr_east.yotsuya),
  ...
  [LINE_IDS.jr_east.oume]: new Line('青梅線', 'JR東日本', [new KindDef("青梅快特", "rapid")], [
    new StopStationDef(STATION_IDS.jr_east.tachikawa, ["rapid"]),
  ...
  [LINE_IDS.jr_east.chuo_soubu_kankou]: new Line('中央・総武緩行線(中央・総武線各停)', 'JR東日本', LOCAL_ONLY, [
  ...
  [LINE_IDS.jr_east.soubu_honsen]: new Line('総武本線(総武線快速)', 'JR東日本', [new KindDef("総武線快速", "rapid")], [
    new StopStationDef(STATION_IDS.jr_east.tokyo, ["rapid"]),
  ...
  // #region 千葉
  [LINE_IDS.jr_east.sotobou]: new Line('外房線', 'JR東日本', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.chiba),
  ...
  [LINE_IDS.jr_east.uchibou]: new Line('内房線', 'JR東日本', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.soga),
  ...
  [LINE_IDS.jr_east.kururi]: new Line('久留里線', 'JR東日本', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.kisaradu),
  ...
  [LINE_IDS.jr_east.narita2]: new Line('成田線[佐倉-銚子]', 'JR東日本', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.sakura),
  ...
  [LINE_IDS.jr_east.ryoumou]: new Line('両毛線', 'JR東日本', [], [
    new StopStationDef(STATION_IDS.jr_east.shinmaebashi),
    new StopStationDef(STATION_IDS.jr_east.maebashi),
  ...
  [LINE_IDS.jr_east.mito]: new Line('水戸線', 'JR東日本', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_east.oyama),
  ...
  [LINE_IDS.jr_east.shinkansen.tokaido]: new Line('東海道新幹線', 'JR東日本', [
    ...
    new StopStationDef(STATION_IDS.jr_east.shin_yokohama, ["rapid", "semi-express", "express"]),
  ...
  // #region 京成電鉄
  [LINE_IDS.keisei.honsen]: new Line('京成本線', COMPANIES.keisei.id, LOCAL_ONLY, [
  ...
  [LINE_IDS.keisei.yukarigaoka]: new Line('ユーカリが丘線', COMPANIES.keisei.id, LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.keisei.yukarigaoka),
  ...
  [LINE_IDS.keisei.sky_liner]: new Line('スカイライナー', '京成電鉄', [], [
    new StopStationDef(STATION_IDS.keisei.keisei_ueno),
    new StopStationDef(STATION_IDS.jr_east.nippori),
    new StopStationDef(STATION_IDS.keisei.aoto),
  ...
  [LINE_IDS.keisei.narita_kuko]: new Line('京成成田空港線(京成成田スカイアクセス)', COMPANIES.keisei.id, [], [
    new StopStationDef(STATION_IDS.keisei.narita_kuko),
    new StopStationDef(STATION_IDS.keisei.kuko_daini_bill),
  ...
  // #endregion
  // #region 新京成電鉄
  [LINE_IDS.shin_keisei.shin_keisei]: new Line('新京成線', '新京成電鉄', [], [
  ...
  [LINE_IDS.toubu.toujou]: new Line('東上線', '東武鉄道', [
    ...
    new StopStationDef(STATION_IDS.toubu.narimasu, ["special-express", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.tokyo_metro.wakoshi, ["f", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.asaka, ["special-express", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.asakadai, ["f", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.shigi, ["special-express", "express", "semi-express"]),
    ...
    new StopStationDef(STATION_IDS.toubu.fujimino, ["tj", "special-express", "express", "semi-express"]),
    ...
    new StopStationDef(STATION_IDS.toubu.kawagoeshi, ["f", "tjd", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.kasumigaseki, ["f", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.tsurugashima, ["f", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.wakaba, ["f", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.sakato, ["f", "tj", "tjd", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.kita_sakato, ["f", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.kousaka, ["f", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.higashi_matsuyama, ["f", "tj", "tjd", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.shinrin_koen, ["f", "tj", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.tsukinowa, ["tjd", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.musashi_arashiyama, ["tjd", "special-express", "rapid", "express", "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.ogawamachi, ["tjd", "special-express", "rapid", "express", "semi-express"]),
  ...
  [LINE_IDS.toubu.urban_park_line]: new Line('東武アーバンパークライン', '東武鉄道', [
    ...
    new StopStationDef(STATION_IDS.toubu.iwatsuki, [Express.KEY, "semi-express"]),
    ...
    new StopStationDef(STATION_IDS.toubu.kasukabe, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.fujinoushijima, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.minami_sakurai, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.kawama, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.nanakoudai, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.shimizu_koen, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.atago, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.nodashi, [Express.KEY, "semi-express"]),
    new StopStationDef(STATION_IDS.toubu.umesato, [Express.KEY, "semi-express"]),
  ...
  [LINE_IDS.toubu.ogose]: new Line('東武越生線', '東武鉄道', LOCAL_ONLY, [
  ...
  [LINE_IDS.toubu.isezaki]: new Line('伊勢崎線', '東武鉄道', [new Express, new SectionExpress, new SemiExpress, new SectionSemiExpress], [
    ...
    new StopStationDef(STATION_IDS.toubu.hikifune, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    ...
    new StopStationDef(STATION_IDS.tokyo_metro.kitasenju, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    ...
    new StopStationDef(STATION_IDS.toubu.nishi_arai, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    new StopStationDef(STATION_IDS.toubu.takenotsuka, []),
    new StopStationDef(STATION_IDS.toubu.tanitsuka, []),
    new StopStationDef(STATION_IDS.toubu.souka, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    ...
    new StopStationDef(STATION_IDS.toubu.shin_koshigaya, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    new StopStationDef(STATION_IDS.toubu.koshigaya, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    ...
    new StopStationDef(STATION_IDS.toubu.sengendai, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    ...
    new StopStationDef(STATION_IDS.toubu.kasukabe, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    ...
    new StopStationDef(STATION_IDS.toubu.toubu_doubutsu_kouen, [Express.KEY,SectionExpress.KEY,SemiExpress.KEY,SectionSemiExpress.KEY]),
    new StopStationDef(STATION_IDS.toubu.wado, [Express.KEY,SectionExpress.KEY,SectionSemiExpress.KEY,SemiExpress.KEY,]),
    new StopStationDef(STATION_IDS.jr_east.kuki, [Express.KEY,SectionExpress.KEY,SectionSemiExpress.KEY,SemiExpress.KEY,]),
  ...
  // #region 千葉
  [LINE_IDS.kominato.kominato]: new Line('小湊鐡道線', '小湊鐡道', [new KindDef("房総里山トロッコ", "rapid")], [
  ...
  [LINE_IDS.jr_hokkaidou.sekihoku_honsen]: new Line('石北本線', 'JR北海道', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_hokkaidou.asahikawa),
    new StopStationDef(STATION_IDS.jr_hokkaidou.asahikawa_shijou),
    new StopStationDef(STATION_IDS.jr_hokkaidou.shin_asahikawa),
  ...
  [LINE_IDS.jr_hokkaidou.senmou_honsen]: new Line('釧網本線', 'JR北海道', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_hokkaidou.abashiri),
  ...
  [LINE_IDS.jr_hokkaidou.hanasaki]: new Line('花咲線', 'JR北海道', LOCAL_ONLY, [
  ...
  [LINE_IDS.jr_hokkaidou.muroran_honsen1]: new Line('室蘭本線[長万部ー岩見沢]', 'JR北海道', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_hokkaidou.osyamanbe),
  ...
  [LINE_IDS.jr_hokkaidou.muroran_honsen2]: new Line('室蘭本線[東室蘭ー室蘭]', 'JR北海道', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_hokkaidou.higashi_muroran),
  ...
  [LINE_IDS.jr_hokkaidou.sassyou]: new Line('札沼線', 'JR北海道', LOCAL_ONLY, [
    new StopStationDef(STATION_IDS.jr_hokkaidou.souen),
