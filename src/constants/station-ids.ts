...
export const STATION_IDS = {
  ...
  tokyo_subway: {
    ...
    ushigome_yanagicho: "ushigomeyanagicho",
    ushigome_kagurazaka: "ushigomekagurazaka",
    kasuga: "kasuga",
  ...
  jr_east: {
    ...
    hino: "hino",
    toyoda: "toyoda",
    nishi_hachiouji: "nishihachiouji",
    takao: "takao",
    sagamiko: "kanagawa-sagamiko",
    fujino: "kanagawa-fujino",
    uenohara: "yamanashi-uenohara",
    shiotsu: "yamanashi-shiotsu",
    ...
    katsunuma_budoukyou: "yamanashi-katsunuma-budoukyou",
    enzan: "yamanashi-enzan",
    higashi_yamanashi: "yamanashi-higashi-yamanashi",
    yamanashishi: "yamanashi-yamanashishi",
    kasugaichou: "yamanashi-kasugaichou",
    isawa_onsen: "yamanashi-isawa-onsen",
    sakaori: "yamanashi-sakaori",
    koufu: "yamanashi-koufu",
    ryuou: "yamanashi-ryuou",
    shiozaki: "yamanashi-shiozaki",
    nirasaki: "yamanashi-nirasaki",
    shinpu: "yamanashi-shinpu",
    anayama: "yamanashi-anayama",
    hinoharu: "yamanashi-hinoharu",
    nagasaka: "yamanashi-nagasaka",
    kobuchizawa: "nagano-kobuchizawa",
    shinano_sakai: "nagano-shinano-sakai",
    fujimi: "nagano-fujimi",
    suzuran_no_sato: "nagano-suzuran-no-sato",
    aoyanagi: "nagano-aoyanagi",
    chino: "nagano-chino",
    kami_suwa: "nagano-kami-suwa",
    shimo_suwa: "nagano-shimo-suwa",
    okaya: "nagano-okaya",
    midoriko: "nagano-midoriko",
    shiojiri: "nagano-shiojiri",
    kawagishi: "nagano-kawagishi",
    tatsuno: "nagano-tatsuno",
    shinano_kawashima: "nagano-shinano-kawashima",
    ono: "nagano-ono",
    // #endregion
    // #region 青梅線(JC)
    ...
    toda: "toda",
    kitatoda: "kitatoda",
    musashi_urawa: "musashiurawa",
    naka_urawa: "nakaurawa",
    minamiyono: "minamiyono",
    yono_honmachi: "yonohonmachi",
    kita_yono: "kitayono",
    mejiro: "mejiro",
    takadanobaba: "takadanobaba",
    shin_ohkubo: "shinokubo",
    yoyogi: "yoyogi",
    harajuku: "harajuku",
    shibuya: "shibuya",
    ebisu: "ebisu",
    ...
    echigo_nakazato: "jr-east-echigo-nakazato",
    iwappara_skijoumae: "jr-east-iwappara-skijoumae",
    ishiuchi: "jr-east-ishiuchi",
    oosawa: "jr-east-oosawa",
    jouetsu_kokusai_skijoumae: "jr-east-jouetsu-kokusai-skijoumae",
    shiozawa: "jr-east-shiozawa",
    muikamachi: "jr-east-muikamachi",
    itsukamachi: "jr-east-itsukamachi",
    yairo: "jr-east-yairo",
    koide: "jr-east-koide",
    echigo_horinouchi: "jr-east-echigo-horinouchi",
    kita_horinouchi: "jr-east-kita-horinouchi",
    echigo_kawaguchi: "jr-east-echigo-kawaguchi",
    odiya: "jr-east-odiya",
    ...
    shiwa_chuou: "jr-east-shiwa-chuo",
    ...
    // 上越線
    gunmasouja: "jr-east-gunmasousya",
  ...
  toubu: {
    ...
    // 日光線
    sugitotakanodai: "toubu-sugitotakanodai",
    satte: "toubu-satte",
    minami_kurihashi: "toubu-minami-kurihashi",
    shin_koga: "toubu-shin-koga",
    yagyu: "toubu-yagyu",
    itakuratouyoudaimae: "toubu-itakuratouyoudaimae",
    fujioka: "toubu-fujioka",
    shizuwa: "toubu-shizuwa",
    shin_ohirashita: "toubu-shin-ohirashita",
    shin_tochigi: "toubu-shin-tochigi",
    kassenba: "toubu-kassenba",
    ienaka: "toubu-ienaka",
    toubu_kanasaki: "toubu-toubu-kanasaki",
    niregi: "toubu-niregi",
    momiyama: "toubu-momiyama",
    shin_kanuma: "toubu-shin-kanuma",
    kita_kanuma: "toubu-kita-kanuma",
    itaga: "toubu-itaga",
    shimokoshiro: "toubu-shimokoshiro",
    myoujin: "toubu-myoujin",
    kami_imaichi: "toubu-kami-imaichi",
    toubu_nikko: "toubu-toubu-nikko",
    // 宇都宮線
    yasyu_hirakawa: "toubu-yasyu-hirakawa",
    yasyu_otsuka: "toubu-yasyu-otsuka",
    mibu: "toubu-mibu",
    kuniya: "toubu-kuniya",
    omochanomachi: "toubu-omochanomachi",
    yasuduka: "toubu-yasuduka",
    nishi_kawada: "toubu-nishi-kawada",
    ...
    sano: "toubu-sano",
    horigome: "toubu-horigome",
    yoshimizu: "toubu-yoshimizu",
    tanuma: "toubu-tanuma",
    tada: "toubu-tada",
    kuzuu: "toubu-kuzuu",
    // kiryu線
    sanmaibashi: "toubu-sanmaibashi",
    jiroenbashi: "toubu-jiroenbashi",
    yabuduka: "toubu-yabuduka",
    azami: "toubu-azami",
    shin_kiryu: "toubu-shin-kiryu",
    aioi: "toubu-aioi",
    akagi: "toubu-akagi",
    // koizumi
    narushima: "toubu-narushima",
    hon_nakano: "toubu-hon-nakano",
    shinoduka: "toubu-shinoduka",
  ...
  odakyu: {
    sagamiono: "sagamiono",
    higashi_rinkan: "higashirinkan",
    chuou_rinkan: "chuorinkan",
    minami_rinkan: "minamirinkan",
    tsuruma: "tsuruma",
    yamato: "yamato",
    ...
    // 小田原線
    minami_shinjuku: "minamishinjuku",
    sangubashi: "sangubashi",
    yoyogi_hachiman: "yoyogihachiman",
    yoyogi_uehara: "yoyogiuehara",
    higashi_kitazawa: "higashikitazawa",
    shimokitazawa: "shimokitazawa",
    setagaya_daita: "setagayadaita",
    umegaoka: "umegaoka",
    gotokuji: "gotokuji",
    kyoudou: "kyodo",
    chitose_funabashi: "chitosefunabashi",
    soshigaya_okura: "soshigayaokura",
    seijogakuenmae: "seijogakuenmae",
    kitami: "kitami",
    komae: "komae",
    izumi_tamagawa: "izumitamagawa",
    mukougaokayuen: "mukougaokayuen",
    ikuta: "ikuta",
    yomiuri_land_mae: "yomiuri-land-mae",
    yurigaoka: "yurigaoka",
    shin_yurigaoka: "shinyurigaoka",
    ...
    isehara: "isehara",
    tsurumaki_onsen: "tsurumakionsen",
    toukaidaigakumae: "toukaidaigakumae",
    hadano: "hadano",
    shibusawa: "shibusawa",
    shin_matsuda: "shinmatsuda",
    kaisei: "kaisei",
    kayama: "kayama",
    tomizu: "tomizu",
    hotaruda: "hotaruda",
  ...
  // #region 千葉
  maihama_resort: {
    resort_gateway: "maihama-resort-gateway",
    tokyo_disneyland: "maihama-tokyo-disneyland",
    bayside: "maihama-bayside",
    tokyo_disneysea: "maihama-tokyo-disneysea",
  },
  /** 京成 駅 */
  keisei: {
  ...
  jr_toukai: {
    ...
    shizuoka: "shizuoka",
    kakegawa: "shizuoka-kakegawa",
    hamamatsu: "hamamatsu",
    toyohashi: "toyohashi",
    mikawa_anjou: "mikawaanjo",
    nagoya: "nagoya",
    ...
    // #region 東海道本線
    atami: "shizuoka-atami",
    shimada: "shizuoka-shimada",
    anjou: "shizuoka-anjou",
    kannami: "shizuoka-kannami",
    numadu: "shizuoka-numadu",
    katahama: "shizuoka-katahama",
    hara: "shizuoka-hara",
    higashi_tagonoura: "shizuoka-higashi-tagonoura",
    yoshiwara: "shizuoka-yoshiwara",
    fuji: "shizuoka-fuji",
    fujikawa: "shizuoka-fujikawa",
    shin_kanbara: "shizuoka-shin-kanbara",
    kanbara: "shizuoka-kanbara",
    yui: "shizuoka-yui",
    okitsu: "shizuoka-okitsu",
    shimizu: "shizuoka-shimizu",
    kusanagi: "shizuoka-kusanagi",
    higashi_shizuoka: "shizuoka-higashi-shizuoka",
    abekawa: "shizuoka-abekawa",
    mochimune: "shizuoka-mochimune",
    yaidu: "shizuoka-yaidu",
    nishi_yaidu: "shizuoka-nishi-yaidu",
    fujieda: "shizuoka-fujieda",
    rokugou: "shizuoka-rokugou",
    kanaya: "shizuoka-kanaya",
    kikukawa: "shizuoka-kikukawa",
    aino: "shizuoka-aino",
    fukuroi: "shizuoka-fukuroi",
    mikurya: "shizuoka-mikurya",
    iwata: "shizuoka-iwata",
    toyodachou: "shizuoka-toyodachou",
    tenryugawa: "shizuoka-tenryugawa",
    takatsuka: "shizuoka-takatsuka",
    maisaka: "shizuoka-maisaka",
    bentenjima: "shizuoka-bentenjima",
    araimachi: "shizuoka-araimachi",
    washidu: "shizuoka-washidu",
    shinjohara: "shizuoka-shinjohara",
    futagawa: "aichi-futagawa",
    nishi_kozakai: "aichi-nishi-kozakai",
    aichi_mito: "aichi-aichi-mito",
    mikawa_ootsuka: "aichi-mikawa-ootsuka",
    mikawa_miya: "aichi-mikawa-miya",
    gamagori: "aichi-gamagori",
    mikawa_shiotsu: "aichi-mikawa-shiotsu",
    sangane: "aichi-sangane",
    kouda: "aichi-kouda",
    aimi: "aichi-aimi",
    okazaki: "aichi-okazaki",
    nishi_okazaki: "aichi-nishi-okazaki",
    higashi_kariya: "aichi-higashi-kariya",
    nodashinmachi: "aichi-nodashinmachi",
    kariya: "aichi-kariya",
    aiduma: "aichi-aiduma",
    oobu: "aichi-oobu",
    kyouwa: "aichi-kyouwa",
    minami_oodaka: "aichi-minami-oodaka",
    oodaka: "aichi-oodaka",
    kasadera: "aichi-kasadera",
    atsuta: "aichi-atsuta",
    kanayama: "aichi-kanayama",
    otoubashi: "aichi-otoubashi",
    biwajima: "aichi-biwajima",
    kiyosu: "aichi-kiyosu",
    inazawa: "aichi-inazawa",
    owari_ichinomiya: "aichi-owari-ichinomiya",
    kisogawa: "aichi-kisogawa",
    gifu: "gifu-gifu",
    nishi_gifu: "gifu-nishi-gifu",
    hodumi: "gifu-hodumi",
    oogaki: "gifu-oogaki",
    tarui: "gifu-tarui",
    sekigahara: "gifu-sekigahara",
    kashiwabara: "gifu-kashiwabara",
    ...
    // #region 身延線
    yunoki: "shizuoka-yunoki",
    tatebori: "shizuoka-tatebori",
    iriyamase: "shizuoka-iriyamase",
    fujine: "shizuoka-fujine",
    gendouji: "shizuoka-gendouji",
    fujinomiya: "shizuoka-fujinomiya",
    nishi_fujinomiya: "shizuoka-nishi-fujinomiya",
    numakubo: "shizuoka-numakubo",
    sibakawa: "shizuoka-sibakawa",
    inako: "shizuoka-inako",
    tohshima: "shizuoka-toshima",
    ide: "shizuoka-ide",
    yorihata: "shizuoka-yorihata",
    utsubuna: "shizuoka-utsubuna",
    kai_ohshima: "shizuoka-kai-ohshima",
    minobu: "shizuoka-minobu",
    shionosawa: "shizuoka-shionosawa",
    hadakajima: "shizuoka-hadakajima",
    shimobe_onsen: "shizuoka-shimobe_onsen",
    kai_tokiwa: "shizuoka-kai-tokiwa",
    ichinose: "shizuoka-ichinose",
    kunado: "shizuoka-kunado",
    kai_iwama: "shizuoka-kai-iwama",
    ochii: "shizuoka-ochii",
    kajikazawaguchi: "shizuoka-kajikazawaguchi",
    ichikawa_daimon: "shizuoka-ichikawa-daimon",
    ichikawa_honmachi: "shizuoka-ichikawa-honmachi",
    ashigawa: "shizuoka-ashigawa",
    kai_ueno: "shizuoka-kai-ueno",
    higashi_hanawa: "shizuoka-higashi-hanawa",
    koikawa: "shizuoka-koikawa",
    jouei: "shizuoka-jouei",
    kokubo: "shizuoka-kokubo",
    kai_sumiyoshi: "shizuoka-kai-sumiyoshi",
    minami_koufu: "shizuoka-minami-koufu",
    zenkouji: "shizuoka-zenkouji",
    ...
    ohzone: "aichi-ohzone",
    shinmoriyama: "aichi-shinmoriyama",
    kachigawa: "aichi-kachigawa",
    kasugai: "aichi-kasugai",
    jinryou: "aichi-jinryou",
    kouzouji: "aichi-kouzouji",
    joukouji: "aichi-joukouji",
    kokokei: "aichi-kokokei",
    tajimi: "gifu-tajimi",
    tokishi: "gifu-tokishi",
    mizunami: "gifu-mizunami",
    takenami: "gifu-takenami",
    ena: "gifu-ena",
    mino_sakamoto: "gifu-mino-sakamoto",
    nakatsugawa: "gifu-nakatsugawa",
    ochiaigawa: "gifu-ochiaigawa",
    sakashita: "gifu-sakashita",
    tadachi: "gifu-tadachi",
    nagiso: "nagano-nagiso",
    juhnikane: "nagano-juunikane",
    nojiri: "nagano-nojiri",
    ohkuwa: "nagano-ohkuwa",
    suhara: "nagano-suhara",
    kuramoto: "nagano-kuramoto",
    agematsu: "nagano-agematsu",
    kiso_fukushima: "nagano-kiso-fukushima",
    harano: "nagano-harano",
    miyanokoshi: "nagano-miyanokoshi",
    yabuhara: "nagano-yabuhara",
    narai: "nagano-narai",
    kiso_hirasawa: "nagano-kiso-hirasawa",
    niekawa: "nagano-niekawa",
  ...
  izu_hakone: {
    ...
    midorichou: "izu-hakone-midoricho",
    // 駿豆線
