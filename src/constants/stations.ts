...
export const STATIONS = {
  ...
  [STATION_IDS.tokyo_subway.shinsen_shinjuku]: new StationInfo('新線新宿', [
    ...
    new ExchangeInfo(LINE_IDS.jr_east.chuou_honsen, STATION_IDS.jr_east.shinjuku),
  ...
  [STATION_IDS.tokyo_subway.kokuritsu_kyogijo]: new StationInfo('国立競技場', [
    LINE_IDS.tokyo_subway.oedo,
    new ExchangeInfo(LINE_IDS.jr_east.chuou_honsen, STATION_IDS.jr_east.sendagaya),
  ], "こくりつきょうぎじょう"),
  ...
  // ＞日暮里・舎人ライナー
  [STATION_IDS.tokyo_subway.akado_shogakko_mae]: new StationInfo('赤土小学校前', [], 'あかどしょうがっこうまえ'),
  [STATION_IDS.tokyo_subway.kumanomae]: new StationInfo('熊野前', [
    LINE_IDS.tokyo_subway.nippori_toneri_liner,
    LINE_IDS.tokyo_subway.sakura_tram,
  ], 'くまのまえ'),
  [STATION_IDS.tokyo_subway.adachi_odai]: new StationInfo('足立小台', [], 'あだちおだい'),
  [STATION_IDS.tokyo_subway.ougiohashi]: new StationInfo('扇大橋', [], 'おうぎおおはし'),
  [STATION_IDS.tokyo_subway.takano]: new StationInfo('高野', [], 'たかの'),
  [STATION_IDS.tokyo_subway.kouhoku]: new StationInfo('江北', [], 'こうほく'),
  [STATION_IDS.tokyo_subway.nishiaraidaishi_nishi]: new StationInfo('西新井大師西', [], 'にしあらいだいしにし'),
  [STATION_IDS.tokyo_subway.yazaike]: new StationInfo('谷在家', [], 'やざいけ'),
  [STATION_IDS.tokyo_subway.toneri_koen]: new StationInfo('舎人公園', [], 'とねりこうえん'),
  [STATION_IDS.tokyo_subway.toneri]: new StationInfo('舎人', [], 'とねり'),
  [STATION_IDS.tokyo_subway.minumadaishinsui_koen]: new StationInfo('南千住大橋水辺公園', [], 'みなみすみだいおおはしみずべこうえん'),
  // 東京さくらトラム
  ...
  [STATION_IDS.tokyo_metro.yoyogi_koen]: new StationInfo('代々木公園', [], "よよぎこうえん"),
  [STATION_IDS.tokyo_metro.machiya]: new StationInfo('町屋', [
    LINE_IDS.tokyo_metro.chiyoda,
    LINE_IDS.keisei.honsen,
    LINE_IDS.tokyo_subway.sakura_tram,
  ], "まちや"),
  [STATION_IDS.tokyo_metro.shin_ochanomizu]: new StationInfo('新御茶ノ水', [
    ...
    new ExchangeInfo(LINE_IDS.jr_east.chuou_honsen, STATION_IDS.jr_east.ochanomizu),
    new ExchangeInfo(LINE_IDS.jr_east.chuo_soubu_kankou, STATION_IDS.jr_east.ochanomizu),
  ], "しんおちゃのみず"),
  // #endregion 都営地下鉄
  //   #region 東京モノレール
  ...
  [STATION_IDS.keisei.shin_mikawashima]: new Station({name: '新三河島', pron: "しんみかわしま", pr: P.TOKYO}),
  [STATION_IDS.keisei.senju_ohashi]: new Station({name: '千住大橋', pron: "せんじゅおおはし", pr: P.TOKYO}),
  [STATION_IDS.keisei.keisei_sekiya]: new Station({name: '京成関屋', pron: "けいせいせきや", pr: P.TOKYO}),
  [STATION_IDS.keisei.horikirisyobuen]: new Station({name: '堀切菖蒲園', pron: "ほりきりしょうぶえん", pr: P.TOKYO}),
  [STATION_IDS.keisei.ohanadyaya]: new Station({name: 'お花茶屋', pron: "おおはなだ", pr: P.TOKYO}),
  [STATION_IDS.keisei.keisei_koiwa]: new Station({name: '京成小岩', pron: "けいせいこいわ", pr: P.TOKYO}),
  [STATION_IDS.keisei.edogawa]: new Station({name: '江戸川', pron: "えどがわ", pr: P.TOKYO}),
  [STATION_IDS.keisei.takanodai]: new Station({name: '高野台', pron: "たかのだい", pr: P.TOKYO}),
  [STATION_IDS.keisei.ichikawa_mama]: new Station({name: '市川真間', pron: "いちかわまま", pr: P.CHIBA}),
  [STATION_IDS.keisei.sugano]: new Station({name: '菅野', pron: "すがの", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_hachiman]: new Station({name: '京成八幡', pron: "けいせいはちまん", pr: P.CHIBA, lines: [
    LINE_IDS.keisei.honsen,
    new ExchangeInfo(LINE_IDS.jr_east.chuo_soubu_kankou, STATION_IDS.jr_east.motoyawata),
    new ExchangeInfo(LINE_IDS.tokyo_subway.shinjuku, STATION_IDS.jr_east.motoyawata),
  ]}),
  [STATION_IDS.keisei.onigoe]: new Station({name: '鬼越', pron: "おにごえ", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_nakayama]: new Station({name: '京成中山', pron: "けいせいなかやま", pr: P.CHIBA}),
  [STATION_IDS.keisei.higashi_nakayama]: new Station({name: '東中山', pron: "ひがしなかやま", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_nishifuna]: new Station({name: '京成西船', pron: "けいせいにしふな", pr: P.CHIBA}),
  [STATION_IDS.keisei.kaijin]: new Station({name: '海神', pron: "かいじん", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_funabashi]: new Station({name: '京成船橋', pron: "けいせいふなばし", pr: P.CHIBA, lines: [
    new ExchangeInfo(LINE_IDS.jr_east.sobu_kaisoku, STATION_IDS.jr_east.funabashi),
    new ExchangeInfo(LINE_IDS.jr_east.chuo_soubu_kankou, STATION_IDS.jr_east.funabashi),
    new ExchangeInfo(LINE_IDS.toubu.urban_park_line, STATION_IDS.jr_east.funabashi),
  ]}),
  [STATION_IDS.keisei.daijingushita]: new Station({name: '大神宮下', pron: "だいじんぐした", pr: P.CHIBA}),
  [STATION_IDS.keisei.funabashi_keibajo]: new Station({name: '船橋競馬場', pron: "ふなばしけいばじょう", pr: P.CHIBA}),
  [STATION_IDS.keisei.yatsu]: new Station({name: '谷津', pron: "やつ", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_okubo]: new Station({name: '京成大久保', pron: "けいせいおおくぼ", pr: P.CHIBA}),
  [STATION_IDS.keisei.mimomi]: new Station({name: '実籾', pron: "みもみ", pr: P.CHIBA}),
  [STATION_IDS.keisei.yachiyodai]: new Station({name: '八千代台', pron: "やちよだい", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_owada]: new Station({name: '京成大和田', pron: "けいせいおおわだ", pr: P.CHIBA}),
  [STATION_IDS.keisei.katsutadai]: new Station({name: '勝田台', pron: "かつただい", pr: P.CHIBA, lines: [
    LINE_IDS.keisei.honsen,
    new ExchangeInfo(LINE_IDS.toyo_kousoku.toyo_kousoku, STATION_IDS.touyou_kousoku.touyou_katsutadai),
  ]}),
  [STATION_IDS.keisei.shidu]: new Station({name: '志津', pron: "しづ", pr: P.CHIBA}),
  [STATION_IDS.keisei.yukarigaoka]: new Station({name: 'ユーカリが丘', pron: "ゆーかりがおか", pr: P.CHIBA, lines: [
    LINE_IDS.keisei.honsen,
    LINE_IDS.keisei.yukarigaoka,
  ]}),
  [STATION_IDS.keisei.keisei_shirai]: new Station({name: '京成白井', pron: "けいせいしらい", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_sakura]: new Station({name: '京成佐倉', pron: "けいせいさくら", pr: P.CHIBA}),
  [STATION_IDS.keisei.osakura]: new Station({name: '大佐倉', pron: "おおさくら", pr: P.CHIBA}),
  ...
  //     #endregion ユーカリが丘線
  //    #region 金町線
  [STATION_IDS.keisei.shibamata]: new Station({name: '柴又', pron: "しばまた", pr: P.CHIBA}),
  [STATION_IDS.keisei.keisei_kanamachi]: new Station({name: '京成金町', pron: "けいせいかなまち", pr: P.CHIBA, lines: [
    LINE_IDS.keisei.kanamachi,
  ...
  [STATION_IDS.keisei.chiba_chuou]: new Station({name: '千葉中央', pron: "ちばちゅうおう", pr: P.CHIBA, lines: [
    LINE_IDS.keisei.chiba,
    LINE_IDS.keisei.chihara,
  ]}),
  [STATION_IDS.keisei.chibadera]: new Station({name: '千葉寺', pron: "ちばでら", pr: P.CHIBA}),
  [STATION_IDS.keisei.omoridai]: new Station({name: '大森台', pron: "おおもりだい", pr: P.CHIBA}),
  [STATION_IDS.keisei.gakuenmae]: new Station({name: '学園前', pron: "がくえんまえ", pr: P.CHIBA}),
  [STATION_IDS.keisei.oyumino]: new Station({name: 'おゆみ野', pron: "おゆみの", pr: P.CHIBA}),
  [STATION_IDS.keisei.chiharadai]: new Station({name: 'ちはら台', pron: "ちはらだい", pr: P.CHIBA}),
  ...
  [STATION_IDS.kominato.kazusa_mitsumata]: new Station({name: '上総三又', pron: "かずさみつまた", pr: P.CHIBA}),
  [STATION_IDS.kominato.kazusa_yamada]: new Station({name: '上総山田', pron: "かずさやまだ", pr: P.CHIBA}),
  [STATION_IDS.kominato.koufudai]: new Station({name: '光風台', pron: "こうふうだい", pr: P.CHIBA}),
  [STATION_IDS.kominato.umatate]: new Station({name: '馬立', pron: "うまたて", pr: P.CHIBA}),
  [STATION_IDS.kominato.kazusa_ushiku]: new Station({name: '上総牛久', pron: "かずさうしく", pr: P.CHIBA}),
  [STATION_IDS.kominato.kazusa_kawama]: new Station({name: '上総川間', pron: "かずさかわま", pr: P.CHIBA}),
  [STATION_IDS.kominato.kazusa_tsurumai]: new Station({name: '上総鶴舞', pron: "かずさつるまい", pr: P.CHIBA}),
  [STATION_IDS.kominato.kazusa_kubo]: new Station({name: '上総久保', pron: "かずさくぼ", pr: P.CHIBA}),
  [STATION_IDS.kominato.takataki]: new Station({name: '高滝', pron: "たかたき", pr: P.CHIBA}),
  [STATION_IDS.kominato.satomi]: new Station({name: '里見', pron: "さとみ", pr: P.CHIBA}),
  [STATION_IDS.kominato.itabu]: new Station({name: '飯給', pron: "いたぶ", pr: P.CHIBA}),
  [STATION_IDS.kominato.tsukizaki]: new Station({name: '月崎', pron: "つきざき", pr: P.CHIBA}),
  [STATION_IDS.kominato.kazusa_okubo]: new Station({name: '上総大久保', pron: "かずさおおくぼ", pr: P.CHIBA}),
  [STATION_IDS.kominato.yourou_keikoku]: new Station({name: '養老渓谷', pron: "ようろうけいこく", pr: P.CHIBA}),
  [STATION_IDS.kominato.kazusa_nakano]: new Station({name: '上総中野', pron: "かずさなかの", pr: P.CHIBA}),
  //   #endregion 小湊鉄道
  //  #endregion 千葉
  //  #region 神奈川
  //   #region 相模鉄道
  ...
  // #endregion >>横浜高速鉄道
  //   #region 京急
  [STATION_IDS.keikyu.kitashinagawa]: new Station({name: '北品川', pron: "きたしながわ", pr: P.TOKYO}),
  [STATION_IDS.keikyu.shinbanba]: new Station({name: '新馬場', pron: "しんばんば", pr: P.TOKYO}),
  [STATION_IDS.keikyu.aomonoyokocho]: new Station({name: '青物横丁', pron: "あおものよこちょう", pr: P.TOKYO}),
  [STATION_IDS.keikyu.samezu]: new Station({name: '鮫洲', pron: "さめず", pr: P.TOKYO}),
  [STATION_IDS.keikyu.tachiaigawa]: new Station({name: '立会川', pron: "たちあいがわ", pr: P.TOKYO}),
  [STATION_IDS.keikyu.omorikaigan]: new Station({name: '大森海岸', pron: "おおもりかいがん", pr: P.TOKYO}),
  [STATION_IDS.keikyu.heiwajima]: new Station({name: '平和島', pron: "へいわじま", pr: P.TOKYO}),
  [STATION_IDS.keikyu.omorimachi]: new Station({name: '大森町', pron: "おおもりまち", pr: P.TOKYO}),
  [STATION_IDS.keikyu.umeyashiki]: new Station({name: '梅屋敷', pron: "うめやしき", pr: P.TOKYO}),
  [STATION_IDS.keikyu.keikyukamata]: new Station({name: '京急蒲田', pron: "けいきゅうかまた", pr: P.TOKYO, lines: [
    LINE_IDS.keikyu.honsen,
  ...
  [STATION_IDS.jr_east.higashijujo]: new Station({name: '東十条', pron: "ひがしじゅうじょう", pr: P.TOKYO}),
  [STATION_IDS.jr_east.ouji]:  new Station({name: '王子', pron: "おうじ", pr: P.TOKYO}),
  [STATION_IDS.jr_east.kaminakazato]: new Station({name: '上中里', pron: "かみなかざと", pr: P.TOKYO}),
  [STATION_IDS.jr_east.tabata]: new Station({name: '田端', pron: "たばた", pr: P.TOKYO}),
  [STATION_IDS.jr_east.nippori]: new Station({name: '日暮里', pron: "にっぽり", pr: P.TOKYO, lines: [
  ...
  [STATION_IDS.jr_east.ueno]: new Station({name: '上野', pron: "うえの", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.keihin_touhoku,
    LINE_IDS.jr_east.yamanote,
    LINE_IDS.jr_east.takasaki,
    LINE_IDS.jr_east.jouban,
  ...
  [STATION_IDS.jr_east.okachimachi]: new Station({name: '御徒町', pron: "おかちまち", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.keihin_touhoku,
    LINE_IDS.jr_east.yamanote,
  ]}),
  [STATION_IDS.jr_east.akihabara]: new Station({name: '秋葉原', pron: "あきはばら", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.yamanote,
    LINE_IDS.jr_east.keihin_touhoku,
    LINE_IDS.tokyo_metro.hibiya,
    LINE_IDS.shutoken_shintoshi.tsukuba_express,
  ...
  [STATION_IDS.jr_east.kanda]: new Station({name: '神田', pron: "かんだ", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.yamanote, LINE_IDS.jr_east.chuou_honsen,
    LINE_IDS.jr_east.keihin_touhoku
  ]}),
  [STATION_IDS.jr_east.tokyo]: new Station({name: '東京', pron: "とうきょう", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.yamanote,
    LINE_IDS.jr_east.keihin_touhoku,
    LINE_IDS.jr_east.chuou_honsen,
  ...
  [STATION_IDS.jr_east.chiba]: new Station({name: '千葉', pron: "ちば", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.chuo_soubu_kankou,
    LINE_IDS.jr_east.sobu_kaisoku,
  ...
  [STATION_IDS.jr_east.nishichiba]: new Station({name: '西千葉', pron: 'にしちば', pr: P.CHIBA}),
  [STATION_IDS.jr_east.inage]: new Station({name: '稲毛', pron: 'いなげ', pr: P.CHIBA}),
  [STATION_IDS.jr_east.shinkemigawa]: new Station({name: '新検見川', pron: 'しんけみがわ', pr: P.CHIBA}),
  [STATION_IDS.jr_east.makuhari]: new Station({name: '幕張', pron: 'まくはり', pr: P.CHIBA}),
  [STATION_IDS.jr_east.makuharihongou]: new Station({name: '幕張本郷', pron: 'まくはりほんごう', pr: P.CHIBA}),
  [STATION_IDS.jr_east.tsudanuma]: new Station({name: '津田沼', pron: 'つだぬま', pr: P.CHIBA}),
  [STATION_IDS.jr_east.higashi_funabashi]: new Station({name: '東船橋', pron: 'ひがしふなばし', pr: P.CHIBA}),
  ...
  [STATION_IDS.jr_east.shin_nihonbashi]: new StationInfo('新日本橋', [], "しんにほんばし"),
  ...
  [STATION_IDS.jr_east.kunitachi]: new Station({name: '国立', pron: "くにたち", pr: P.TOKYO}),
  [STATION_IDS.jr_east.tachikawa]: new Station({name: '立川', pron: "たちかわ", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.oume,
    LINE_IDS.jr_east.nanbu,
    LINE_IDS.jr_east.chuou_honsen,
    LINE_IDS.tama_monorail.tama_monorail,
  ]}),
  [STATION_IDS.jr_east.hino]: new Station({name: '日野', pron: "ひの", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.chuou_honsen,
    LINE_IDS.jr_east.chuo_soubu_kankou,
  ]}),
  [STATION_IDS.jr_east.toyoda]: new Station({name: '豊田', pron: "とよだ", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.chuou_honsen,
    LINE_IDS.jr_east.chuo_soubu_kankou,
  ]}),
  [STATION_IDS.jr_east.nishihachiouji]: new Station({name: '西八王子', pron: "にしはちおうじ", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.chuou_honsen,
    LINE_IDS.jr_east.chuo_soubu_kankou,
  ]}),
  [STATION_IDS.jr_east.takao]: new Station({name: '高尾', pron: "たかお", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.chuou_honsen,
    LINE_IDS.jr_east.chuo_soubu_kankou,
    LINE_IDS.keiou.takao,
  ]}),
  ...
  [STATION_IDS.jr_east.hachiouji]: new Station({name: '八王子', pron: "はちおうじ", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.chuou_honsen,
    LINE_IDS.jr_east.yokohama,
    LINE_IDS.jr_east.hachiko,
  ]}),
  ...
  [STATION_IDS.jr_east.kanamachi]: new Station({name: '金町', pron: "かなまち", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.jouban,
    new ExchangeInfo(LINE_IDS.keisei.kanamachi, STATION_IDS.keisei.keisei_kanamachi),
  ]}),
  ...
  [STATION_IDS.jr_east.abiko]: new Station({name: '我孫子',pron: "あびこ", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.jouban,
    LINE_IDS.jr_east.narita1,
  ]}),
  ...
  // #endregion 南武線
  // #region 総武本線(JO)
  [STATION_IDS.jr_east.shin_nihonbashi]: new Station({name: '新日本橋', pron: "しんにほんばし", pr: P.TOKYO}),
  [STATION_IDS.jr_east.bakurocho]: new Station({name: '馬喰町', pron: "ばくろちょう", pr: P.TOKYO}),
  [STATION_IDS.jr_east.nishi_chiba]: new Station({name: '西千葉', pron: "にしちば", pr: P.CHIBA}),
  [STATION_IDS.jr_east.higashi_chiba]: new Station({name: '東千葉', pron: "ひがしちば", pr: P.CHIBA}),
  [STATION_IDS.jr_east.tsuga]: new Station({name: '都賀', pron: "つが", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.soubu_honsen,
    LINE_IDS.chiba_toshi_monorail.nigou,
  ]}),
  [STATION_IDS.jr_east.yotsukaidou]: new Station({name: '四街道', pron: "よつかいどう", pr: P.CHIBA}),
  [STATION_IDS.jr_east.monoi]: new Station({name: '物井', pron: "ものい", pr: P.CHIBA}),
  [STATION_IDS.jr_east.sakura]: new Station({name: '佐倉', pron: "さくら", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.soubu_honsen,
    LINE_IDS.jr_east.narita2,
  ]}),
  [STATION_IDS.jr_east.minami_shisui]: new Station({name: '南酒々井', pron: "みなみしずい", pr: P.CHIBA}),
  [STATION_IDS.jr_east.enokido]: new Station({name: '榎戸', pron: "えのきど", pr: P.CHIBA}),
  [STATION_IDS.jr_east.yachimata]: new Station({name: '八街', pron: "やちまた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.hyuga]: new Station({name: '日向', pron: "ひゅうが", pr: P.CHIBA}),
  [STATION_IDS.jr_east.narutou]: new Station({name: '成東', pron: "なるとう", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.soubu_honsen,
    LINE_IDS.jr_east.tougane,
  ]}),
  [STATION_IDS.jr_east.matsuo]: new Station({name: '松尾', pron: "まつお", pr: P.CHIBA}),
  [STATION_IDS.jr_east.yokoshiba]: new Station({name: '横芝', pron: "よこしば", pr: P.CHIBA}),
  [STATION_IDS.jr_east.iigura]: new Station({name: '飯倉', pron: "いいぐら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.youkaichiba]: new Station({name: '八日市場', pron: "ようかいちば", pr: P.CHIBA}),
  [STATION_IDS.jr_east.higata]: new Station({name: '干潟', pron: "ひがた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.asahi]: new Station({name: '旭', pron: "あさひ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.iioka]: new Station({name: '飯岡', pron: "いいおか", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kurahashi]: new Station({name: '倉橋', pron: "くらはし", pr: P.CHIBA}),
  [STATION_IDS.jr_east.saruda]: new Station({name: '猿田', pron: "さるだ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.matsugishi]: new Station({name: '松岸', pron: "まつぎし", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.soubu_honsen,
    LINE_IDS.jr_east.narita2,
  ]}),
  [STATION_IDS.jr_east.choshi]: new Station({name: '銚子', pron: "ちょうし", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.soubu_honsen,
    LINE_IDS.jr_east.narita2,
  ...
  // #endregion 総武本線
  // #region 八高線(JW)
  [STATION_IDS.jr_east.kita_hachiouji]: new Station({name: '北八王子', pron: "きたはちおうじ", pr: P.TOKYO}),
  [STATION_IDS.jr_east.komiya]: new Station({name: '小宮', pron: "こみや", pr: P.TOKYO}),
  [STATION_IDS.jr_east.haijima]: new Station({name: '拝島', pron: "はいじま", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.hachiko,
    LINE_IDS.jr_east.oume,
    LINE_IDS.jr_east.itsukaichi,
    LINE_IDS.seibu.haijima,
  ]}),
  [STATION_IDS.jr_east.higashi_fussa]: new Station({name: '東福生', pron: "ひがしふっさ", pr: P.TOKYO}),
  [STATION_IDS.jr_east.hakonegasaki]: new Station({name: '箱根ヶ崎', pron: "はこねがさき", pr: P.TOKYO}),
  [STATION_IDS.jr_east.kaneko]: new Station({name: '金子', pron: "かねこ", pr: P.TOKYO}),
  [STATION_IDS.jr_east.higashi_hanno]: new Station({name: '東飯能', pron:"ひがしはんのう", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.hachiko,
    LINE_IDS.seibu.seibu_chichibu,
  ]}),
  [STATION_IDS.jr_east.moro]: new Station({name: '諸', pron: "もろ", pr: P.TOKYO}),
  [STATION_IDS.jr_east.ogose]: new Station({name: '越生', pron: "おごせ", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.hachiko,
    LINE_IDS.toubu.ogose,
  ]}),
  [STATION_IDS.jr_east.myoukaku]: new Station({name: '明覚', pron: "みょうかく", pr: P.TOKYO}),
  [STATION_IDS.jr_east.ogawamachi]: new Station({name: '小川町', pron: "おがわまち", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.hachiko,
    LINE_IDS.toubu.toujou,
  ]}),
  [STATION_IDS.jr_east.takezawa]: new Station({name: '竹沢', pron: "たけざわ", pr: P.TOKYO}),
  [STATION_IDS.jr_east.orihara]: new Station({name: '折原', pron: "おりはら", pr: P.TOKYO}),
  [STATION_IDS.jr_east.yorii]: new Station({name: '寄居', pron: "よりい", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.hachiko,
    LINE_IDS.toubu.toujou,
    LINE_IDS.chichibu.chichibu,
  ]}),
  [STATION_IDS.jr_east.youdo]: new Station({name: '用土', pron: "ようど", pr: P.TOKYO}),
  [STATION_IDS.jr_east.matsuhisa]: new Station({name: '松久', pron: "まつひさ", pr: P.TOKYO}),
  [STATION_IDS.jr_east.kodama]: new Station({name: '児玉', pron: "こだま", pr: P.TOKYO}),
  [STATION_IDS.jr_east.tanshou]: new Station({name: '丹荘', pron: "たんしょう", pr: P.TOKYO}),
  [STATION_IDS.jr_east.gunma_fujioka]: new Station({name: '群馬藤岡', pron: "ぐんまふじおか", pr: P.GUNMA}),
  [STATION_IDS.jr_east.kita_fujioka]: new Station({name: '北藤岡', pron: "きたふじおか", pr: P.GUNMA}),
  // #endregion 八高線
  // #region 湘南新宿ライン(JS)
  [STATION_IDS.jr_east.kumagaya]: new Station({name: '熊谷', pron: "くまがや", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.takasaki,
    LINE_IDS.jr_east.shonan_shinjuku,
    LINE_IDS.jr_east.shinkansen.hokuriku,
    LINE_IDS.chichibu.chichibu
  ]}),
  [STATION_IDS.jr_east.takasaki]: new Station({name: '高崎', pron: "たかさき", pr: P.TOKYO, lines: [
    LINE_IDS.jr_east.takasaki,
    LINE_IDS.jr_east.shonan_shinjuku,
    LINE_IDS.jr_east.shinkansen.jouetsu,
    LINE_IDS.jr_east.jouetsu,
  ...
  // #endregion 両毛線
  // #region 水戸線
  [STATION_IDS.jr_east.odabayashi]: new Station({name: '小田林', pron: "おだばやし", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.yuki]: new Station({name: '結城', pron: "ゆうき", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.higashi_yuki]: new Station({name: '東結城', pron: "ひがしゆうき", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.kawashima]: new Station({name: '川島', pron: "かわしま", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.tamado]: new Station({name: '玉戸', pron: "たまど", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.shimodate]: new Station({name: '下館', pron: "しもだて", pr: P.IBARAKI, lines: [
    LINE_IDS.jr_east.mito,
    LINE_IDS.moka.moka,
    LINE_IDS.kantou.jousou,
  ]}),
  [STATION_IDS.jr_east.niibari]: new Station({name: '新治', pron: "にいばり", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.yamato]: new Station({name: '大和', pron: "やまと", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.iwase]: new Station({name: '岩瀬', pron: "いわせ", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.haguro]: new Station({name: '羽黒', pron: "はぐろ", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.fukuhara]: new Station({name: '福原', pron: "ふくはら", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.inada]: new Station({name: '稲田', pron: "いなだ", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.kasama]: new Station({name: '笠間', pron: "かさま", pr: P.IBARAKI}),
  [STATION_IDS.jr_east.shishido]: new Station({name: '宍戸', pron: "ししど", pr: P.IBARAKI}),
  // #endregion 水戸線
  // #region 外房線
  [STATION_IDS.jr_east.hon_chiba]: new Station({name: '本千葉', pron: "ほんちば", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kamatori]: new Station({name: '鎌取', pron: "かまとり", pr: P.CHIBA}),
  [STATION_IDS.jr_east.honda]: new Station({name: '誉田', pron: "ほんだ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.toke]: new Station({name: '土気', pron: "とけ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.oami]: new Station({name: '大網', pron: "おおあみ", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.sotobou,
    LINE_IDS.jr_east.tougane,
  ]}),
  [STATION_IDS.jr_east.nagata]: new Station({name: '永田', pron: "ながた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.honnou]: new Station({name: '本納', pron: "ほんのう", pr: P.CHIBA}),
  [STATION_IDS.jr_east.shin_mobara]: new Station({name: '新茂原', pron: "しんもばら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.mobara]: new Station({name: '茂原', pron: "もばら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.yatsumi]: new Station({name: '八積', pron: "やつみ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kazusa_ichinomiya]: new Station({name: '上総一ノ宮', pron: "かずさいちのみや", pr: P.CHIBA}),
  [STATION_IDS.jr_east.torami]: new Station({name: '東浪見', pron: "とらみ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.taitou]: new Station({name: '太東', pron: "たいとう", pr: P.CHIBA}),
  [STATION_IDS.jr_east.choujamachi]: new Station({name: '長者町', pron: "ちょうじゃまち", pr: P.CHIBA}),
  [STATION_IDS.jr_east.mikado]: new Station({name: '三門', pron: "みかど", pr: P.CHIBA}),
  [STATION_IDS.jr_east.ohara]: new Station({name: '大原', pron: "おおはら", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.sotobou,
    LINE_IDS.izumi.izumi,
  ]}),
  [STATION_IDS.jr_east.namihana]: new Station({name: '浪花', pron: "なみはな", pr: P.CHIBA}),
  [STATION_IDS.jr_east.onjuku]: new Station({name: '御宿', pron: "おんじゅく", pr: P.CHIBA}),
  [STATION_IDS.jr_east.katsuura]: new Station({name: '勝浦', pron: "かつうら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.ubara]: new Station({name: '鵜原', pron: "うばら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kazusa_okitsu]: new Station({name: '上総興津', pron: "かずさおきつ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.namegawa_island]: new Station({name: '行川アイランド', pron: "なめがわあいらんど", pr: P.CHIBA}),
  [STATION_IDS.jr_east.awa_kominato]: new Station({name: '安房小湊', pron: "あわこみなと", pr: P.CHIBA}),
  [STATION_IDS.jr_east.awa_amatsu]: new Station({name: '安房天津', pron: "あわあまつ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.awa_kamogawa]: new Station({name: '安房鴨川', pron: "あわかもがわ", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.sotobou,
    LINE_IDS.jr_east.uchibou,
  ]}),
  // #endregion 外房線
  // #region 内房線
  [STATION_IDS.jr_east.hamano]: new Station({name: '浜野', pron: "はまの", pr: P.CHIBA}),
  [STATION_IDS.jr_east.yawatajuku]: new Station({name: '八幡宿', pron: "やわたじゅく", pr: P.CHIBA}),
  [STATION_IDS.jr_east.goi]: new Station({name: '五井', pron: "ごい", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.uchibou,
    LINE_IDS.kominato.kominato,
  ]}),
  [STATION_IDS.jr_east.anegasaki]: new Station({name: '姉ヶ崎', pron: "あねがさき", pr: P.CHIBA}),
  [STATION_IDS.jr_east.nagaura]: new Station({name: '長浦', pron: "ながうら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.sodegaura]: new Station({name: '袖ケ浦', pron: "そでがうら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.iwane]: new Station({name: '巌根', pron: "いわね", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kisaradu]: new Station({name: '木更津', pron: "きさらづ", pr: P.CHIBA, lines: [
    LINE_IDS.jr_east.uchibou,
    LINE_IDS.jr_east.kururi,
  ]}),
  [STATION_IDS.jr_east.kimitsu]: new Station({name: '君津', pron: "きみつ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.aohori]: new Station({name: '青堀', pron: "あおほり", pr: P.CHIBA}),
  [STATION_IDS.jr_east.onuki]: new Station({name: '大貫', pron: "おおぬき", pr: P.CHIBA}),
  [STATION_IDS.jr_east.sanukimachi]: new Station({name: '佐貫町', pron: "さぬきまち", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kazusa_minato]: new Station({name: '上総湊', pron: "かずさみなと", pr: P.CHIBA}),
  [STATION_IDS.jr_east.takeoka]: new Station({name: '竹岡', pron: "たけおか", pr: P.CHIBA}),
  [STATION_IDS.jr_east.hamakanaya]: new Station({name: '浜金谷', pron: "はまかなや", pr: P.CHIBA}),
  [STATION_IDS.jr_east.hota]: new Station({name: '保田', pron: "ほた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.awa_katsuyama]: new Station({name: '安房勝山', pron: "あわかつやま", pr: P.CHIBA}),
  [STATION_IDS.jr_east.iwai]: new Station({name: '岩井', pron: "いわい", pr: P.CHIBA}),
  [STATION_IDS.jr_east.tomiura]: new Station({name: '富浦', pron: "とみうら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.nakofunakata]: new Station({name: '那古船形', pron: "なこふなかた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kokonoe]: new Station({name: '九重', pron: "ここのえ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.chikura]: new Station({name: '千倉', pron: "ちくら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.chitose]: new Station({name: '千歳', pron: "ちとせ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.minamihara]: new Station({name: '南原', pron: "みなみはら", pr: P.CHIBA}),
  [STATION_IDS.jr_east.wadaura]: new Station({name: '和田浦', pron: "わだうら", pr: P.CHIBA}),
  ...
  // #endregion 東金線
  // #region 久留里線
  [STATION_IDS.jr_east.gion]: new Station({name: '祇園', pron: "ぎおん", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kazusa_kiyokawa]: new Station({name: '上総清川', pron: "かずさきよかわ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.higashi_kiyokawa]: new Station({name: '東清川', pron: "ひがしきよかわ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.yokota]: new Station({name: '横田', pron: "よこた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.higashi_yokota]: new Station({name: '東横田', pron: "ひがしよこた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.makuta]: new Station({name: '馬来田', pron: "まくた", pr: P.CHIBA}),
  [STATION_IDS.jr_east.shimogoori]: new Station({name: '下郡', pron: "しもごおり", pr: P.CHIBA}),
  [STATION_IDS.jr_east.obitsu]: new Station({name: '小櫃', pron: "おびつ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.tawarada]: new Station({name: '俵田', pron: "たわらだ", pr: P.CHIBA}),
  [STATION_IDS.jr_east.kururi]: new Station({name: '久留里', pron: "くるり", pr: P.CHIBA}),
  [STATION_IDS.jr_east.hirayama]: new Station({name: '平山', pron: "ひらやま", pr: P.CHIBA}),
  ...
  [STATION_IDS.jr_west.komatsu]: new StationInfo('小松', [
    LINE_IDS.jr_east.shinkansen.hokuriku,
    LINE_IDS.ir_ishikawa.ir_ishikawa,
  ], "こまつ"),
  ...
  [STATION_IDS.jr_west.awara_onsen]: new StationInfo('芦原温泉', [
    LINE_IDS.jr_east.shinkansen.hokuriku,
    LINE_IDS.hapi_line_fukui.hapi_line_fukui,
  ], "あわらおんせん"),
  [STATION_IDS.jr_west.fukui]: new StationInfo('福井', [
    LINE_IDS.jr_east.shinkansen.hokuriku,
    LINE_IDS.jr_west.kuzuryu,
    LINE_IDS.hapi_line_fukui.hapi_line_fukui,
    LINE_IDS.echizen.katsuyama_eiheiji,
    LINE_IDS.echizen.mikuni_awara,
    new ExchangeInfo(LINE_IDS.fukui.fukui_tetsudo, STATION_IDS.fukui.fukuieki),
  ], "ふくい"),
  [STATION_IDS.jr_west.echizen_takefu]: new StationInfo('越前たけふ', [], "えちぜんたけふ"),
  [STATION_IDS.jr_west.tsuruga]: new StationInfo('敦賀', [
    LINE_IDS.jr_east.shinkansen.hokuriku,
