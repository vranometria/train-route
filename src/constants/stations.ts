...
export const STATIONS = {
  ...
  [STATION_IDS.jr_east.higashikoganei]: new StationInfo('東小金井', []),
  [STATION_IDS.jr_east.musashikoganei]: new StationInfo('武蔵小金井', []),
  ...
  [STATION_IDS.jr_east.kunitachi]: new StationInfo('国立', []),
